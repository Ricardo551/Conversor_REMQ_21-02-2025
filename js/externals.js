const requestNotificationPermission = async ()=>{
    ...
    if(permission !== 'granted'){
        ...
        new Notification("Hola, mi nombre es Ricardo Ernesto Mejía Quintanilla, soy estudiante de la Universidad Francisco Gavidia.");
    }
}
    ...
    const comenzarAGrabar = () =>{
        ...
        navigator.mediaDevices.getUserMedia({
            ...
            mediaRecorder.addEventListener("stop", ()=>{
                ...
                a.download = "ricardoernestomejiaquintanilla.ufg.webm";
                a.click();
